...
"color:black;")
        ...
        self.gridLayout_3.addWidget(self.input, 3, 0, 2, 1)
        ...
        self.gridLayout_3.addWidget(self.output, 3, 1, 2, 1)
        ...
        self.parse = QtWidgets.QPushButton(self.Parser)
        self.parse.setObjectName("parse")
        self.gridLayout_4.addWidget(self.parse, 2, 0, 1, 1)
